...
### Citing this work
This repository contains the official MATLAB implementation accompanying the following research paper, which is currently under review:

> **Davide Pellecchia et al.** (2026). *"Evaluation of high-order moments for plane and solid closed domains bounded by arbitrary-degree Bézier curves and surfaces"*. Submitted to [Nome della Rivista xxx].
